...
public class KnapsackTest {
  ...
  public void solver_capacityLessThanWeightOfItems_returnsZero() {
    ...
    assertThat(Knapsack.solverWithBottomUp(items, capacity)).isEqualTo(0);
  ...
  public void solver_largeEnoughCapacity_returnsSumValues() {
    ...
    assertThat(Knapsack.solverWithBottomUp(items, capacity)).isEqualTo(12);
  ...
  public void solver_smallCapacity_returnsMaxValue() {
    ...
    assertThat(Knapsack.solverWithBottomUp(items, capacity)).isEqualTo(7);
  ...
  public void solver() {
    ...
    assertThat(Knapsack.solverWithBottomUp(items, capacity)).isEqualTo(16);
